...
#"$HOME/src/gpdb$GP_MAJOR/src/test/regress/pg_regress" --inputdir="$HOME/src/diskquota/build/tests/regress" --outputdir="$HOME/src/diskquota/build/tests/regress" --load-extension=gp_inject_fault --init-file=init_file config test_create_extension test_plpgsql reset_config
"$HOME/src/gpdb$GP_MAJOR/src/test/regress/pg_regress" --inputdir="$HOME/src/diskquota/build/tests/regress" --outputdir="$HOME/src/diskquota/build/tests/regress" --load-extension=gp_inject_fault --init-file=init_file config test_create_extension test_clean_config_tables reset_config
