...
"$HOME/src/gpdb$GP_MAJOR/src/test/isolation2/pg_isolation2_regress" --inputdir="$HOME/src/diskquota/build/tests/isolation2" --outputdir="$HOME/src/diskquota/build/tests/isolation2" --init-file=init_file config test_create_extension reset_config
