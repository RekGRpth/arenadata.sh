...
declare -A DEPS=(
  ...
  [join]="text int2 int4 int8 float8 copy"
  [aggregates]="int4 int8 create_aggregate"
  [portals]="int8 copy"
  [arrays]="int8 copy"
  [btree_index]="copy"
  [hash_index]="copy"
  ...
  [plancache]="int8 copy"
  [limit]="int8 copy"
  [plpgsql]="int4 int8 rangetypes copy"
  [rangefuncs]="int4 int8 rangetypes"
  [prepare]="copy"
  [conversion]="create_function_1"
  [alter_table]="insert create_index"
