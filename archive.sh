...
gpconfig -c restore_command --skipvalidation -v "'PGOPTIONS=\"-c gp_session_role=utility\" pgbackrest --stanza=seg%c archive-push %p'"
gpstop -afr

archive_command = 'gzip -cfk "%p" >"../arc/%f.gz"'
restore_command = 'gunzip -cfk "../arc/%f.gz" >"%p"'
exit
