...
python3 ../scripts/fix_mdps.py --logFile "$HOME/src/gpdb$GP_MAJOR/failures.out"
#../scripts/fix_mdps.py --logFile "$HOME/src/gpdb$GP_MAJOR/failures.out"
