...
#$PIP 
pip3 install pyyaml==6.0.1 pyxb-x==1.2.6.1 numpy==1.25.2 pyxb pypmml dill==0.3.7 hyperopt==0.2.5 tensorflow==2.10 pandas==2.0.3 scipy==1.11.2 grpcio==1.57.0 protobuf==3.19.4 scikit-learn==1.3.0 xgboost==1.7.6
